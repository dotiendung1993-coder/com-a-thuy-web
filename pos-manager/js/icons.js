...
export const ICONS = {
  ...
  // Đối chiếu giá vốn NVL (2026-09-18) — 2 mũi tên ngược chiều, tượng trưng đối chiếu/so khớp.
  'doi-chieu-von': S('<path d="M4 8h13"/><path d="M17 8 13.5 4.5"/><path d="M17 8 13.5 11.5"/><path d="M20 16H7"/><path d="M7 16 10.5 12.5"/><path d="M7 16 10.5 19.5"/>'),
  ...
  // Đợt 14 (24/08/2026) — thẻ "MỤC TIÊU DOANH THU" ở Tổng quan giờ có icon riêng (hình bia ngắm/
  // mục tiêu) giống các thẻ KPI khác, thay vì chỉ có nút bút chì "Đặt mục tiêu" trơ trọi.
  'muc-tieu': S('<circle cx="12" cy="12" r="8.5"/><circle cx="12" cy="12" r="5"/><circle cx="12" cy="12" r="1.6" fill="currentColor" stroke="none"/>'),
  ...
  // Đợt 4 (04/09/2026) — nút "Bộ lọc" và nút vuông chọn cột ở màn Đơn hàng. Ảnh mẫu SoBanHang
  // vẽ cả hai bằng cùng một kiểu "núm gạt": mấy đường ngang, mỗi đường một núm tròn.
  'bo-loc': S('<path d="M4 7h16M4 12h16M4 17h16"/><circle cx="9" cy="7" r="2" fill="#fff"/><circle cx="15" cy="12" r="2" fill="#fff"/><circle cx="8" cy="17" r="2" fill="#fff"/>'),
  'cot-hien-thi': S('<path d="M4 9h16M4 15h16"/><circle cx="10" cy="9" r="2" fill="#fff"/><circle cx="15" cy="15" r="2" fill="#fff"/>'),
  // Đợt 4 (04/09/2026) — cặp mũi tên nhỏ trên tiêu đề cột sắp xếp được (ảnh mẫu màn Sản phẩm).
  'sap-xep': S('<path d="M8 10.5 12 6l4 4.5"/><path d="M8 13.5 12 18l4-4.5"/>'),
  // Task 4 (03/09/2026) — 2 nút sắp xếp khu vực ở drawer "Quản lý khu vực". Bộ icon cũ chỉ
  // có 'quay-lai' (mũi tên NGANG) nên nút lên/xuống không có gì để vẽ.
  'mui-ten-len': S('<path d="M12 19V5"/><path d="M6 11l6-6 6 6"/>'),
  'mui-ten-xuong': S('<path d="M12 5v14"/><path d="M6 13l6 6 6-6"/>'),
  'quay-lai': S('<path d="M14.5 5.5 8 12l6.5 6.5"/>'),
  // Việc header (23/08/2026 đợt 2) — icon "?" cho nút Trợ giúp (Hướng dẫn sử dụng/Câu hỏi thường
  // gặp) cạnh chuông thông báo, theo ảnh mẫu SoBanHang.
  'tro-giup': S('<circle cx="12" cy="12" r="9"/><path d="M9.3 9.3a2.7 2.7 0 1 1 3.9 2.4c-.8.4-1.2.9-1.2 1.8v.3"/><path d="M12 17.2h.01"/>'),
  // Việc header (23/08/2026) — icon nút "Đổi giao diện" cạnh Cài đặt cuối cột trái. Trước đây
  // 2 nút riêng có chữ "Quay lại giao diện cũ" / "Dùng giao diện mới (thử nghiệm)" — gộp thành
  // 1 icon trung lập (kiểu công tắc gạt), không còn coi giao diện mới là "thử nghiệm".
  'doi-giao-dien': S('<rect x="3" y="9" width="18" height="6" rx="3"/><circle cx="15" cy="12" r="2.3" fill="currentColor" stroke="none"/>'),
...
export const ICON_COLORS = {
  ...
  'uoc-tinh-thue': '#6C5CE7', 'gia-von': '#CA6A11', 'doi-chieu-von': '#2F80ED',
