...
export const ICONS = {
  ...
  'nhap-xuat-kho': S('<rect x="2.5" y="8" width="12" height="8.5" rx="1.5"/><path d="M14.5 11h3l3 3v2.5h-6z"/><circle cx="7" cy="18.5" r="1.6"/><circle cx="17.5" cy="18.5" r="1.6"/>'),
...
export const ICON_COLORS = {
  ...
  'san-pham': '#E8A33D', 'ton-kho': '#0EA5A5', 'nhap-xuat-kho': '#169939', 'so-kho': '#0F9D58',
  'kiem-kho': '#6C5CE7', 'nha-cung-cap': '#D96285', 'nhom-tuy-chon': '#CA6A11',
